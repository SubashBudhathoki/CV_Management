...
import { assesmentUserDetail } from "../../features/Assesment/AssesmentSlice";
import { useEffect } from "react";
import {
  allRejectedUser,
  selectedHiredUser,
} from "../../features/Hired/HiredSlice";
import { assesmentCandidateDetail } from "../../features/Candidate/CandidateSlice";
const AssesmentUserDetail = () => {
  ...
  const testUserDeatail = acceptedUser.find((user) => user.id == id);
  console.log(testUserDeatail);
  // const rejectedUser = assesmentUser.find((user) => user.id == id);
  // console.log(rejectedUser);

  useEffect(() => {
    dispatch(assesmentCandidateDetail(id));
    dispatch(selectedHiredUser(testUserDeatail));
  }, [id, dispatch, testUserDeatail]);
          ...
          <div className="max-w-lg">
            <div className="bg-white shadow-lg h-[40rem]">
              ...
              <div className="w-full h-[15rem] mt-16 px-5">
                <div className="">
                  <h3>
                    {testUserDeatail?.fname}
                    {testUserDeatail?.lname}
                  </h3>
                  <div className="flex">
                  ...
                  <p>
                    <span>
                      {testUserDeatail?.phone}
                      <br />
                      {testUserDeatail?.email}
                      <br />
...
export default AssesmentUserDetail;
