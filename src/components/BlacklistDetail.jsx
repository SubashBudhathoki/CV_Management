...
const BlacklistDetail = () => {
  ...
  const blackListedUser = blackListed.find((user) => user.id === parseInt(id));
      ...
      {blackListedUser && (
        <div className="p-10">
          <div className="bg-white shadow-lg">
            <div className="w-ful bg-gradient-to-r from-black to-red-500 h-[10rem] relative ">
              <div className="flex justify-between">
                <div className="">
                  <img
                    src={blackListedUser?.photo}
                    alt=""
            ...
            <div className="w-full h-[15rem] mt-16 px-2 flex justify-between">
              <div className="">
                <h3>{blackListedUser?.fname + " " + blackListedUser?.lname}</h3>
                <div className="flex">
                ...
                <p>
                  <span>
                    +977-{blackListedUser?.phone} <br />
                    {blackListedUser?.position} Intership at AmnilTechnology
                  </span>
                  <br />
                  <span>Full-time</span>
                </p>
              ...
              <div className="space-y-4">
                <h3 className="font-medium">Reason for Blacklisted ?</h3>
                <p className="underline">{blackListedUser?.blackListReason}</p>
              </div>
              <div className="space-x-3">
                ...
                <button className="font font-semibold py-2 px-4 rounded bg-black text-white border-4 border-gray-200">
                  BlackListed
                </button>
              </div>
            </div>
